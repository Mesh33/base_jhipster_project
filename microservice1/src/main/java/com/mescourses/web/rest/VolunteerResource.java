...
public class VolunteerResource {
    ...
    public ResponseEntity<Void> deleteVolunteer(@PathVariable Long id) {
        ...
        volunteerSearchRepository.delete(id);
    ...
    @Timed
    public List<Volunteer> searchVolunteers(@RequestParam String query) {
        log.debug("REST request to search Volunteers for query {}", query);
        return StreamSupport
            .stream(volunteerSearchRepository.search(queryStringQuery(query)).spliterator(), false)
