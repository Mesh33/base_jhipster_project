...
public class OrganizerResourceIntTest {
    ...
    public void createOrganizer() throws Exception {
        ...
        assertThat(testOrganizer.getUsername()).isEqualTo(DEFAULT_USERNAME);
        assertThat(testOrganizer.getOrganization()).isEqualTo(DEFAULT_ORGANIZATION);
    }
    ...
    public void updateOrganizer() throws Exception {
        ...
        Organizer testOrganizer = organizerList.get(organizerList.size() - 1);
        assertThat(testOrganizer.getUsername()).isEqualTo(UPDATED_USERNAME);
        assertThat(testOrganizer.getOrganization()).isEqualTo(UPDATED_ORGANIZATION);
    }
