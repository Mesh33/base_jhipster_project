...
import com.mescourses.repository.search.ParticipantSearchRepository;
...
public class ParticipantResourceIntTest {
    ...
    public void setup() {
        ...
        final ParticipantResource participantResource = new ParticipantResource(participantRepository, participantSearchRepository);
    ...
    public void createParticipant() throws Exception {
        ...
        assertThat(testParticipant.getParticipant()).isEqualTo(DEFAULT_PARTICIPANT);
    ...
    public void updateParticipant() throws Exception {
        ...
        Participant testParticipant = participantList.get(participantList.size() - 1);
        assertThat(testParticipant.getParticipant()).isEqualTo(UPDATED_PARTICIPANT);
